...
const TutorCard = (props) => {
  const { firstName, lastName, rating, imgUrl, subjectList, price, targetId } =
    props;
  // const [dummySubjects] = useState(["Mathematic", "Science", "Programing", "Algorithm", "Society", "Yaranika"])
  const [dummyColors] = useState([
    'Crimson',
    'CornflowerBlue',
    'CadetBlue',
    'DarkSlateBlue',
    ...
    <div className="tutor-card-container">
      ...
      >
        ...
        <img
          ...
          src={
            imgUrl ??
            'https://www.saraswatiias.com/wp-content/uploads/2018/11/dummy-profile-pic-male1.jpg'
          }
        />
        <div
          style={{
