      ...
      <div className="ban-unban-container">
            ...
            {this.state.isSomethingWentWrong ? (
              ...
              <>
                ...
                {this.state.reportList.map((e, i) => (
                  <ReportCard
                    reportingName={
                      e.targetId.firstName + ' ' + e.targetId.lastName
                    }
                    reporterName={
                      e.reporterId.firstName + ' ' + e.reporterId.lastName
                    }
                    ...
                    onClickCard={() =>
                      this.setState({
                        reportDetailModalData: {
                          ...
                          reporterName:
                            e.reporterId.firstName +
                            ' ' +
                            e.reporterId.lastName,
        ...
        {this.state.isConfirmBanModalShow && (
          <ConfirmBanModal
            ...
            onAcknowledge={() =>
              this.setState({ isConfirmBanModalShow: false })
            }
            targetName={this.state.reportDetailModalData.reportingName}
            duration={this.state.banDuration}
            status={this.state.confirmBanModalStatus}
            onClickConfirmBtn={() =>
              this.onClickBanButton(
                this.state.reportDetailModalData.reportingId
              )
            }
          />
        )}
        {this.state.isConfirmIgnoreModalShow && (
          <ConfirmIgnoreModal
            ...
            onAcknowledge={() =>
              this.setState({ isConfirmIgnoreModalShow: false })
            }
            status={this.state.confirmIgnoreModalStatus}
            onClickConfirmBtn={() =>
              this.onDeleteReport(this.state.reportDetailModalData.reportId)
            }
          />
        )}
      </div>
