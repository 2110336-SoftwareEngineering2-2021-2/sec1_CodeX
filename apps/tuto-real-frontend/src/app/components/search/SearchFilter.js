  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            <Form.Check
              ...
              onChange={() => priceRateRadioHandle(61, 100, 3)}
            />
            <Form.Check
              inline
              label="151 - 250 bath"
              ...
              onChange={() => priceRateRadioHandle(151, 250, 5)}
            />
            <Form.Check
              inline
              label="All"
          ...
          >
            <Form.Check
              ...
              onChange={() => priceRateRadioHandle(31, 60, 2)}
            />
            <Form.Check
              inline
              label="101 - 150 bath"
              ...
              onChange={() => priceRateRadioHandle(101, 150, 4)}
            />
            <Form.Check
              inline
      ...
      <Modal.Footer>
        ...
        <Button onClick={() => onCancelHandle()} variant="outline-secondary">
          Cancel
        </Button>{' '}
        <Button onClick={() => setDefaultHandle()} variant="secondary">
          Set Default
        </Button>{' '}
        <button
